...
export const PART = definePart(
  {
    ...
    'discovery.next': '下一步',
    'discovery.done': '看完了',
    'discovery.toQuiz': '做个小测',
    'discovery.inlineQuiz': '顺手一问',
    'discovery.moreQuiz': '再做几题',
  ...
  },
  {
    ...
    'discovery.next': 'Next',
    'discovery.done': 'Done',
    'discovery.toQuiz': 'Take the quiz',
    'discovery.inlineQuiz': 'One quick question',
    'discovery.moreQuiz': 'A few more questions',
